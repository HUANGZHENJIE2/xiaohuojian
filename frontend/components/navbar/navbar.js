...
function switchTab(name) {
    if (name === Navbar.currentTab)
        return;
    let icon = Navbar[name].querySelector('svg');
    let hzj = document.createElement('svg');
    hzj.innerHTML = Navbar.icons[name].active;
    Navbar[name].replaceChild(hzj,icon)
    Navbar.container.querySelector('.show').classList.remove('show');
    Navbar.container.querySelector(`#${name}Panel`).classList.add('show');
    // Navbar.container.innerHTML = name;
    icon = Navbar[Navbar.currentTab].querySelector('svg');
    hzj = document.createElement('svg');
    hzj.innerHTML = Navbar.icons[Navbar.currentTab].default;
    Navbar[Navbar.currentTab].replaceChild(hzj, icon)

    Navbar.currentTab = name;
}
...
Navbar.status.addEventListener('click', function () {
  switchTab('status');
})

Navbar.settings.addEventListener('click', function () {
    switchTab('settings');
})

Navbar.about.addEventListener('click', function () {
    switchTab('about');
})